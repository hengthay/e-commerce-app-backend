...
const { getAllUser, getUserById, updateUserProfileByAdmin, deleteUserProfileByAdmin, updateUserProfile, deleteUserProfile, getUserProfileById, updateUserProfileAddress } = require('../controller/userController');
...
router.put('/profile-password', authenticateToken, authorizeRoles('user'), updateUserProfile);
router.delete('/profile', authenticateToken, authorizeRoles('user'), deleteUserProfile);
// Update profile and address
router.put('/profile-edit', authenticateToken, authorizeRoles('user', 'admin'), updateUserProfileAddress)
